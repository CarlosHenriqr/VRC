...
import { n as getCasesBySector } from "./cases-CzeAt3pd.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/SectorPage-DL_Oj_dH.js
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FadeIn, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "kicker",
							children: content.domains.kicker
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "mt-5 max-w-3xl font-display text-3xl font-bold tracking-[-0.04em] sm:text-4xl lg:text-5xl",
							children: content.domains.title
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-4 max-w-2xl text-muted-foreground",
							children: content.domains.subtitle
						})
					] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3",
						children: content.domains.items.map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FadeIn, {
							delay: i * .05,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FadeIn, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "kicker",
							children: content.services.kicker
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "mt-5 max-w-3xl font-display text-3xl font-bold tracking-[-0.04em] sm:text-4xl",
						...
						children: content.services.items.map((service, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FadeIn, {
							delay: i * .05,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									...
									children: service.items.map((line) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
