...
async function getServerEntry() {
	if (!serverEntryPromise) serverEntryPromise = import("./server-CS-MXR09.mjs").then((m) => m.default ?? m);
...
//#endregion
export { server_default as default, loadEnv as n, renderErrorPage as t };
