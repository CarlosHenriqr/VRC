...
import { ArrowRight, Instagram, Linkedin, Mail, Phone, MessageCircle } from "lucide-react";
    ...
    <footer className="relative border-t border-hairline pt-20">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-12 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
          <div>
            <BrandLogo showTagline sizeClassName="text-3xl" />
          ...
          <FooterCol
            ...
            links={[
              ...
              ...(FEATURES.cases
                ? [{ label: "Cases", href: "/cases", external: false as const }]
                : []),
