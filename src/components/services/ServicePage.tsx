  ...
  return (
    <div className="relative z-10 min-h-screen bg-background text-foreground">
      ...
      <section className="border-t border-hairline bg-cloud py-24 lg:py-32">
        <div className="mx-auto max-w-6xl px-6">
          <FadeIn>
            <p className="kicker">{content.capabilities.kicker}</p>
      ...
      <section className="py-24 lg:py-32">
        <div className="mx-auto max-w-6xl px-6">
          <FadeIn>
            <p className="kicker">{content.offers.kicker}</p>
            <h2 className="mt-5 max-w-3xl font-display text-3xl font-bold tracking-[-0.04em] sm:text-4xl">
              {content.offers.title}
            </h2>
            <p className="mt-4 max-w-2xl text-muted-foreground">{content.offers.subtitle}</p>
          </FadeIn>
